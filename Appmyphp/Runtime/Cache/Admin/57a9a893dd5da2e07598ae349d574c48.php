...
<link rel="shortcut icon" href="/Appmyphp/Admin/View/Public/images/main/favicon.ico" />
  <script charset="utf-8" src="/Appmyphp/Admin/View/Public/kindeditors/kindeditor.js"></script>
  <script src="/Appmyphp/Admin/View/Public/kindeditors/lang/zh_CN.js"></script>
  <script>
    var editor;
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：帖子管理&nbsp;&nbsp;>&nbsp;&nbsp;修改帖子</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form method="post" action="/admin.php/Case/save/id/1" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          ...
          <input type="text" name="create_time" value="<?php echo (date("Y-m-d H:i:s",$show['create_time'])); ?>" id="today" class="text-word Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
