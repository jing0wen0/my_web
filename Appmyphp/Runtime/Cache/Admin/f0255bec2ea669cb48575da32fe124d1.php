...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="javascript:;" target="mainFrame" onFocus="this.blur()" class="add">修改用户</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="/admin.php/Rbac/saveuser/id/1.html">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户名称：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="username" value="<?php echo ($user['username']); ?>" class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">所属角色：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          <select name="role_id">
            <option value="<?php echo ($user['id']); ?>"><?php echo ($user['name']); ?>(<?php echo ($user['remark']); ?>)</option>
            <?php if($user['username'] != C('RBAC_SUPERADMIN')): if(is_array($role)): foreach($role as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo ($v['name']); ?>(<?php echo ($v['remark']); ?>)</option><?php endforeach; endif; endif; ?>
          </select>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
