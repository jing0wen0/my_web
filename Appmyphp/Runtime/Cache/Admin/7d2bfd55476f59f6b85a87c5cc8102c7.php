...
<link rel="shortcut icon" href="/Appmyphp/Admin/View/Public/images/main/favicon.ico" />
  <script type="text/javascript" charset="utf-8" src="/Appmyphp/Admin/View/Public/kindeditors/kindeditor.js"></script>
  <script type="text/javascript" src="/Appmyphp/Admin/View/Public/kindeditors/lang/zh_CN.js"></script>
...
#search a.add{ background:url("/Appmyphp/Admin/View/Public/images/main/add.jpg") no-repeat 0px 6px; padding:0 10px 0 26px; height:40px; line-height:40px; font-size:14px; font-weight:bold; color:#FFF}
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：案例管理&nbsp;&nbsp;>&nbsp;&nbsp;添加案例</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form method="post" action="/admin.php/Case/add.html" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="title" value="" class="text-word" style="width: 670px;">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td width="10%" align="right" valign="middle" class="borderright borderbottom bggray">描述：</td>
        <td width="90%" align="left" valign="middle" class="borderright borderbottom main-for">
          <textarea name="description" class="miaoshu"></textarea>
        </td>
      </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" id="url" name="thumb" value="" class="text-word"><input type="button" id="image" value="选择图片"/>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">发布时间：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          <script language="javascript" type="text/javascript" src="/Appmyphp/Admin/View/Public/My97DatePicker/WdatePicker.js"></script>
          <input type="text" name="create_time" value="" id="today" class="text-word Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
