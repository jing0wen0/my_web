...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top" id="addinfo">您的位置：留言管理</td>
  </tr>
  <tr>
    <td align="left" valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
        <tr>
          <td width="90%" align="left" valign="middle">&nbsp;&nbsp;&nbsp;<a href="javascript:;" target="mainFrame" onFocus="this.blur()" class="add">留言管理</a></td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th width="50%" align="center" valign="middle" class="borderright">留言标题</th>
        <th width="15%" align="center" valign="middle" class="borderright">留言人姓名</th>
